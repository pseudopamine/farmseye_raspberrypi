...
## 💻MQ135 데이터 적재
https://github.com/user-attachments/assets/c683d22a-1eaf-4c00-88cc-69162957cb5a

- ## 데이터 수집 : 라즈베리파이 센서로 측정한 데이터를 DB에 적재
    - 라즈베리파이 가상 환경에 MySQL 설치
    - 파이썬을 이용해 DB 연결
    - 팀원들 DB에도 동일한 데이터를 동시에 적재
